...
with tempfile.TemporaryDirectory() as temp:
    ...
    with ZipFile(output) as archive:
        ...
        assert 'ZoidsTools_F/SettingsRecovery.lua' in names
        assert 'ZoidsTools_F/Save-BetaPreset.ps1' in names
        assert not any('Preset.lua' in name for name in names)
        ...
        assert 'ZoidsTools_F/Locales/README.md' in names
