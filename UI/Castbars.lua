...
function UI.CreateCastbarsPage(parent)
    ...
    local enabled = UI.CreateCheckbox(page, "Customize this castbar's size", "Use saved width and height. Turn off to restore the original dimensions.",
    ...
    local width = UI.CreateSlider(page, "Width", nil, 120, 420, 1,
    ...
    local height = UI.CreateSlider(page, "Height", nil, 8, 40, 1,
    ...
    local preview = UI.CreateButton(page, "Preview this castbar", 210, 30)
    ...
    preview:SetScript("OnClick", function()
        if ns:IsCastbarPreviewActive(key) then
            ...
            message:SetText(ok and "Showing the actual Blizzard castbar at its current position." or reason)
        end
        page:Refresh()
    end)
    ...
    function page:Refresh()
        ...
        preview:SetText(ns:IsCastbarPreviewActive(key) and "Stop preview" or "Preview this castbar")
    end
