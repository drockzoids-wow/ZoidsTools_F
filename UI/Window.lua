...
local function BuildWindow()
    ...
    function frame:SelectPage(key)
        ...
        activePage = isWindows and windowsPage or page
        page:SetShown(not isWindows)
        windowsPage:SetShown(isWindows)
        selected:SetStyledSelected(not isWindows)
        windowsButton:SetStyledSelected(isWindows)
        subtitle:SetText(isWindows and "FOREVER BETA  /  WINDOWS & BAGS" or "FOREVER BETA  /  DAMAGE METERS")
        activePage:Refresh()
    end
