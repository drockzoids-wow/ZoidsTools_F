...
function UI.CreateStatsPage(parent)
    ...
    local enabled = UI.CreateCheckbox(page, L["Show stats window"],
        L["Show a compact box with FPS, world latency, and current movement speed."],
    ...
    local locked = UI.CreateCheckbox(page, L["Lock position"],
        L["Prevent dragging while keeping hover tooltips. On supported clients, clicks pass through the locked box."],
